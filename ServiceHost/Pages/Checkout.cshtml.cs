...
namespace ServiceHost.Pages
{
    ...
    public class CheckoutModel : PageModel
    {
        ...
        public CheckoutModel(ICartCalculatorService cartCalculatorService,
            ICartService cartService, IProductQuery productQuery, IOrderApplication orderApplication
            , IZarinPalFactory zarinPalFactory, IAuthHelper authHelper)
        ...
        //public IActionResult PaymentForPackageVerify(string Authority)
        //{
        //    var cart = _cartService.Get();
        //    cart.SetPaymentMethod(paymentMethod);
