...
namespace _0_Framework.Application.Sms
{
    public class SmsService : ISmsService
    {
        ...
        public void Send(string number, string message)
        {
            ...
            var sentMessageResponseByDate = new MessageSend().GetByDate(token, "1401/11/01", "1401/09/31", 10, 1);
        ...
        private string GetToken()
        {
            ...
            return tokenService.GetToken("d3729995cf204015fa809995", "10113724539");
        }
    }
}